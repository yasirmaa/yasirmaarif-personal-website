export const ProjectCard = ({
  ...
  return (
    <div className="hover:scale-105 duration-100 col-span-6 md:col-span-3 border shadow-md rounded-2xl p-3 bg-white dark:bg-slate-800">
      ...
      <div className="flex flex-col items-start gap-y-1 mt-2">
        ...
        <a href={link} target="_blank">
          <button className="bg-cyan-600 hover:bg-cyan-500 text-white px-4 py-2 font-semibold rounded-xl text-base md:text-xl">
            View {viewText}
          </button>
        </a>
      </div>
